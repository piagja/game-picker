...
export const SearchButton = () => {
  ...
  return (
    <div
      onClick={handleData}
      className='flex self-center cursor-pointer items-center justify-evenly bg-slate-800 mt-4 h-12 w-36 rounded-lg hover:bg-slate-600 hover:text-slate-300 max-md:w-[20px] max-md:justify-around max-md:h-[60px] max-md:font-bold max-md:tracking-widest max-md:text-2xl'
    >
